...
export type ActionMonitorActionConnection = {
  ...
  edges: Array<ActionMonitorActionConnectionEdge>;
  /** A list of connected ActionMonitorAction Nodes */
  nodes: Array<ActionMonitorAction>;
  /** Information about pagination in a connection. */
  pageInfo: ActionMonitorActionConnectionPageInfo;
};
...
/** Connection between the ActionMonitorAction type and the ActionMonitorAction type */
export type ActionMonitorActionToPreviewConnectionEdge = ActionMonitorActionConnectionEdge & Edge & OneToOneConnection & {
...
/** Connection between the RootQuery type and the ActionMonitorAction type */
export type RootQueryToActionMonitorActionConnection = ActionMonitorActionConnection & Connection & {
  __typename?: 'RootQueryToActionMonitorActionConnection';
  /** Edges for the RootQueryToActionMonitorActionConnection connection */
  edges: Array<RootQueryToActionMonitorActionConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ActionMonitorAction>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToActionMonitorActionConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToActionMonitorActionConnectionEdge = ActionMonitorActionConnectionEdge & Edge & {
...
export type RootQueryToActionMonitorActionConnectionPageInfo = ActionMonitorActionConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToActionMonitorActionConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
